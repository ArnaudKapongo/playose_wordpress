<?php 
class Playose_Social_Widget extends WP_Widget {

    public $fields = [];

    public function __construct()
    {
        parent::__construct('playose_social_widget', __('Social widget', 'playose'));
        $this->fields = [
            'credits' => __('Credits', 'playose'),
            'twitter' => 'Twitter',
            'facebook' => 'Facebook',
            'instagram' => 'Instagram',
            'title' => __('Title', 'playose')
        ];
    }
    public function widget(array $args, $instance): void {
