...
<?php endif; ?>        
  ...
  <div class="rt">
      ...
      <div class="boxactuality">
        <div class="contentactuality">
          ...
          <article>
           ...
           <!-- <h2 class="playose_news_playlist"> --><?php $categories = get_the_category(); 
            if(!empty($categories)): 
            ?>
            <a class="playose_news_playlist" href="<?= get_term_link($categories[0]) ?>"><?= $categories[0]->name  ?></a>
            <?php endif ?>

         <!-- </h2> -->
          
            </div>
            <p class="paragraph_playose_news_playlist"> <?php the_content(); ?></p>
   ...
   <!--   <div class="boxactuality">
    ...
    <!--
    <div class="content_new_and_actuality"> 
...
<div class="card_item">
  <div class="card_inner">
    <div class="card_top">
      <img src="card_img.jpg" alt="car" class="imagecar"/>
    </div>
...
-->
    ...
    <div class="plusac">
      <a href="http://localhost:8888/Playose/contact/">
      <button >Plus</button>
      </a>
    </div>
